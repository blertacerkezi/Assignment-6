...
Blerta Cerkezi
WebID: https://wiser-solid-xi.interactions.ics.unisg.ch/bcer/profile/card#me
Profile file: https://wiser-solid-xi.interactions.ics.unisg.ch/bcer/profile/card
...
Group profile URL (resource): https://wiser-solid-xi.interactions.ics.unisg.ch/bcer/group9.ttl#group
Group profile file (document): https://wiser-solid-xi.interactions.ics.unisg.ch/bcer/group9.ttl
...
Ans: With link traversal enabled, Comunica is able to dereference the foaf:knows links and retrieve information from 
other Solid Pods. This allows discovering friends and friends of friends across distributed WebIDs. Without link 
traversal, only the initial WebID document is queried and no external resources are followed, resulting in fewer or 
no results.
